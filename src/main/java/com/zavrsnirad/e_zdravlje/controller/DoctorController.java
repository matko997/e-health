...
public class DoctorController {
  ...
  public String addNewDoctor(
      User user, BindingResult bindingResult, RedirectAttributes redirectAttributes) {
    ...
    if (Objects.isNull(user.getGraduationYear())) {
      ...
      redirectAttributes.addFlashAttribute(
          "error", "Molimo unesite valjanu vrijednost za godinu završetka studija");
    }
  ...
  @GetMapping("/doktori")
  public String findDoctorsPaginated(
    ...
    model.addAttribute(
        "doctors", userService.findDoctorsPaginatedAndFiltered(pageNumber, size, keyword));
    return "doctor-index";
  }
